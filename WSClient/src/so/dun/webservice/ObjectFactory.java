 ...
 * generated in the so.dun.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudentById_QNAME = new QName("http://webservice.dun.so/", "getStudentById");
    private final static QName _GetStudentsByPriceResponse_QNAME = new QName("http://webservice.dun.so/", "getStudentsByPriceResponse");
    private final static QName _AddStudent_QNAME = new QName("http://webservice.dun.so/", "addStudent");
    private final static QName _GetAllStudentsMap_QNAME = new QName("http://webservice.dun.so/", "getAllStudentsMap");
    private final static QName _GetAllStudentsMapResponse_QNAME = new QName("http://webservice.dun.so/", "getAllStudentsMapResponse");
    private final static QName _AddStudentResponse_QNAME = new QName("http://webservice.dun.so/", "addStudentResponse");
    private final static QName _GetStudentByIdResponse_QNAME = new QName("http://webservice.dun.so/", "getStudentByIdResponse");
    private final static QName _GetStudentsByPrice_QNAME = new QName("http://webservice.dun.so/", "getStudentsByPrice");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: so.dun.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "getStudentById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "getStudentsByPriceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "addStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "getAllStudentsMap")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "getAllStudentsMapResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "addStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "getStudentByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dun.so/", name = "getStudentsByPrice")
